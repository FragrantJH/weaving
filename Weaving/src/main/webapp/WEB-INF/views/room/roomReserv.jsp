		...
		<div class="card">
			...
			<div class="card-body" id="roomname">
				<form name="frm" action="roomInsertReserv" method="POST">
					<input type="hidden" id="resId"> 회의실 <select id="roomr"
						class="custom-select" name="roomId">
					...
					<div class="row" id="leftboxs">
						...
						~
						<div class="col">
							<select name="endTime" id="selectEtime" class="custom-select">
			...
			<div class="card-header card-header-text card-header-primary">
				...
				<form action="roomReserv" name="frm1">
					...
					<div class="statusbutton">
						<button class="btn btn-dark btn-sm" type="button" id="before"
							onclick="show('1')">지난예약</button>
						<button class="btn btn-dark btn-sm" type="button" id="today"
							onclick="show('2')">금일예약</button>
						<button class="btn btn-dark btn-sm" type="button" id="roomone"
							onclick="show('3')">1번룸</button>
						<button class="btn btn-dark btn-sm" type="button" id="roomtwo"
							onclick="show('4')">2번룸</button>
						<button class="btn btn-dark btn-sm" type="button" id="roomthree"
							onclick="show('5')">3번룸</button>
					</div>
				</form>
			</div>
			<div class="card-body">
