            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> 결재 미 완료 문서 중에서 결재를 해야하는 문서</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <c:forEach items="${docWaitList}" var="docList">
                      	<tr>
                      		<td class="text-center">${docList.rowNum}</td>
                      		<td>${docList.docNo}</td>
                      		<td>${docList.docTitle}</td>                      		
                      		<td>${docList.empName}</td>
                      		<td>${docList.regDate}</td>
                      	</tr>
                      </c:forEach>
                      </tbody>
                    </table>
                    <my:paging paging="${paging}" jsFunc="docWaitList" />
                  </div>
                </div>
              </div>
            </div>
